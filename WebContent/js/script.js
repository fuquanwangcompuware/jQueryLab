/**
 * Document Ready function to check session and initialize carousel
 */
$(function(){
	// session check
...
function showUserProfile() {
	...
	// Send request to retrieve user's info
...
/**
 * Processing user login by accepting email and password
 * @param email
 * @param password
 */
function processLogin(email, password){
	
	// email and password empty verification
	...
	$.post("./jsp/updateUser.jsp", 
		...
		.success(function(resp){
			...
			if(resp==="emailExists") {
				...
				// Update the header link after successfully logged in
...
/**
 * Load projects (includes comments & milestones) for a logged in user
 * @param userID
 */
				...
				switch(k){
					...
					case "milestones":
						...
						$.each(v, function(mkey, mvalue){
							...
							// Build HTML to add new milestone
...
/**
 * Update the logged in user link in header
 * @param userName
 * @param userID
 */
...
/**
 * Show project description edit dialog
 * @param projectID
 */
...
/**
 * Show project billing code edit dialog
 * @param projectID
 */
...
/**
 * Show project client name edit dialog
 * @param projectID
 */
...
/**
 * Show project time frame edit dialog
 * @param projectID
 */
...
/**
 * Send request to logout, destroy the session and reload the page
 */
...
/**
 * Show dialog to delete milestone
 * @param milestoneID
 * @param milestoneDivID
 */
...
/**
 * Send request to delete milestone
 */
...
/**
 * Send request to add milestone and build HTML to show up in the page
 */
